...
tpin_sections = ['CONN_rod','CONN_rod_1in', 'CONN_rod_0.7in', 'CON_rod_additional', 'CONN_rod_0.375in', 'CONN_rod_1.25in', 'CONN_rod_1.125in']
...
a.add_frames_to_group('LERA_AllT-pins',t_pins)
...
for tp in t_pins:
    ...
    j_end.append(j)
a.add_joints_to_group('LERA_AllT-pin_ends',j_end)