...
ModelPath = APIPath + os.sep + '201005 - Combined_Model_SEQ_B_EAST v3-Step7-rotatelocal.sdb'
...
ret = SapModel.LoadPatterns.Add('1', LTYPE_OTHER, 0, True)
